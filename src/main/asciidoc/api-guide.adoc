...
include::{snippets}/style-retrieve-success-example/response-fields.adoc[]

==== Example request

include::{snippets}/style-retrieve-success-example/http-request.adoc[]

==== Example response

include::{snippets}/style-retrieve-success-example/http-response.adoc[]
...
include::{snippets}/style-create-success-example/request-fields.adoc[]

==== Example request

include::{snippets}/style-create-success-example/http-request.adoc[]

==== Example response

include::{snippets}/style-create-success-example/http-response.adoc[]
...
include::{snippets}/style-update-success-example/request-fields.adoc[]

==== Example request

include::{snippets}/style-update-success-example/http-request.adoc[]

==== Example response

include::{snippets}/style-update-success-example/http-response.adoc[]
...
include::{snippets}/style-delete-success-example/http-request.adoc[]

==== Example response

include::{snippets}/style-delete-success-example/http-response.adoc[]
